                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="dispo-tab" data-toggle="tab" href="#dispo" role="tab" aria-controls="dispo" aria-selected="false">Disponibilité</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="tab-content profile-tab" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="dispo" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row">
                                <h4> Période disponibilité</h4>
                            </div>
                            <div class="row">

                                <div class="col-md-6">
                                    <label>disponiblité date debut </label>
                                </div>
                                <div class="col-md-4">
                                    <b-form-input id="type-date" type="date" class="form-control"></b-form-input>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label>disponiblité date de fin </label>
                                </div>
                                <div class="col-md-4">
                                    <b-form-input id="type-date" type="date" class="form-control"></b-form-input>
                                </div>
                            ...
                            <div class="row">
                                <div class="pb-2">
                                    <b-button class="float-right" size='md' variant="success">
                                        valider
                                    </b-button>
                                </div>
                            </div>
